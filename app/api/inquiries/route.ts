  ...
  try {
    ...
    const inquiry = await prisma.inquiry.create({
      data: {
        ...
        renterPhone: validatedData.renterPhone || null,
        preferredCallTime: validatedData.preferredCallTime || null,
    ...
    Promise.all([
      sendNewInquiryEmailToOwner({
        ...
        renterName: validatedData.renterName,
        renterEmail: validatedData.renterEmail,
        renterPhone: validatedData.renterPhone,
        preferredCallTime: validatedData.preferredCallTime,
